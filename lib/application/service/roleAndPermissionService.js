...
class Service {
    ...
    obtainAllPermission(traceContext, callback) {
        let self = this
        self._permissionRepository.getAllPermission(traceContext, (err, permissions) => {
            if (err) {
            ...
            for (let permission of permissions) {
                ...
                permissionsJSON.push({permissionID, permissionName});
            }
            callback(null, permissionsJSON);
        });
    };
