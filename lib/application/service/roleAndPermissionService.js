...
class Service {
    ...
    assignPermissionToRole(permissionID, roleID, traceContext, callback) {
        ...
        function* assignPermission() {
            ...
            yield saveRole(role);
            let newRole = yield getRoleFromRepository();
            let {roleID, roleName, permissionIDs} = newRole;
            let result = {roleID, roleName, permissionIDs};
            return result;
        };
        co(assignPermission).then((result) => {
