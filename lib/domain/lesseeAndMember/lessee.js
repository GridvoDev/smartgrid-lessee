...
class Lessee{
    ...
    active() {
        ...
        this._wechatInfo._isActived = true;
        return;
    }
    inactive() {
        this._isActived = false;
        this._wechatInfo._isActived = false;
        return;
    }
    createStation(stationData){
        let station = {};
        station.stationID = stationData.stationID;
        let stationName = stationData.stationName;
        station.stationInfo = new StationInfo({stationName});
