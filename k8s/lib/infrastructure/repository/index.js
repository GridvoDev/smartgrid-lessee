...
const MongodbAndHttpDataSourceRepository = require("./mongodbAndHttpDataSourceRepository");
...
let mongodbAndHttpDataSourceRepository = null;
function createDataSourceRepository(single = true) {
    if (single && mongodbAndHttpDataSourceRepository) {
        return mongodbAndHttpDataSourceRepository;
    }
    mongodbAndHttpDataSourceRepository = new MongodbAndHttpDataSourceRepository();
    return mongodbAndHttpDataSourceRepository;
};
